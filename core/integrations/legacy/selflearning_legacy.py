    ...
    def _find_plugins(self):
        ...
        for attr in (
            ...
            try:
                ...
                # A successful public catalog is authoritative, including an empty
                # result. Private fallback registries can retain unloaded stars.
                if attr == "get_all_stars" and source is not None:
                    return
